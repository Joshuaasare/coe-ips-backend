    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, services_1.insertEntityRecord("company", "user_id,name,email,phone,location_id,postal_address,website,representative_name,representative_phone,representative_email,created_at", "?,?,?,?,?,?,?,?,?,?,?", [companyData], dbInstance)];
            case 4:
