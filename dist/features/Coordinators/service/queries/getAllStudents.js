...
exports.getAllStudents = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var dbInstance, studentQuery, locationQuery, subDepartmentQuery, mainDepartmentQuery, myCondition, join1, join2, join3, condition, mainQuery, students, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                myCondition = "student.user_id != 1820 AND student.user_id != 1821 AND student.user_id != 1822 AND student.user_id != 1823";
