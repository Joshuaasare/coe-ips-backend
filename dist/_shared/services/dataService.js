...
function insertEntityRecord(entity, columns, escapes, params, dbInstance) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    query = "insert into " + entity + " (" + columns + ") values (" + escapes + ")";
                    return [4 /*yield*/, dbInstance.runPreparedQuery(query, params)];
                case 1:
                    rows = _a.sent();
                    return [2 /*return*/, rows];
            }
...
exports.insertEntityRecord = insertEntityRecord;
function updateEntityRecord(query, params, dbInstance) {
    return __awaiter(this, void 0, void 0, function () {
        var rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dbInstance.runPreparedQuery(query, params)];
                case 1:
                    rows = _a.sent();
                    return [2 /*return*/, rows];
            }
...
exports.updateEntityRecord = updateEntityRecord;
function deleteEntityRecord(entity, column, params, dbInstance) {
    return __awaiter(this, void 0, void 0, function () {
        var query, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    query = "delete from " + entity + " where " + column + " = ?";
                    return [4 /*yield*/, dbInstance.runPreparedQuery(query, params)];
                case 1:
                    rows = _a.sent();
                    return [2 /*return*/, rows];
